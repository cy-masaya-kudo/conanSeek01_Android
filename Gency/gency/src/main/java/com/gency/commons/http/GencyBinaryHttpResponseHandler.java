...
/**
 * Used to intercept and handle the responses from requests made using {@link GencyAsyncHttpClient}.
 ...
 * </pre>
 */
public abstract class GencyBinaryHttpResponseHandler extends GencyAsyncHttpResponseHandler {
     ...
     */
    public GencyBinaryHttpResponseHandler() {
        super();
    }
     ...
     */
    public GencyBinaryHttpResponseHandler(String[] allowedContentTypes) {
        super();
