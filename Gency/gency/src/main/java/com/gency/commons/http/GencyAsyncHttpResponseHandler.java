...
/**
 * Used to intercept and handle the responses from requests made using {@link GencyAsyncHttpClient}. The
 ...
 * </pre>
 */
public abstract class GencyAsyncHttpResponseHandler implements GencyResponseHandlerInterface {
    ...
    static class ResponderHandler extends Handler {
        private final WeakReference<GencyAsyncHttpResponseHandler> mResponder;

        ResponderHandler(GencyAsyncHttpResponseHandler service) {
            mResponder = new WeakReference<GencyAsyncHttpResponseHandler>(service);
        }

        @Override
        public void handleMessage(Message msg) {
            GencyAsyncHttpResponseHandler service = mResponder.get();
            if (null != service) {
     ...
     */
    public GencyAsyncHttpResponseHandler() {
