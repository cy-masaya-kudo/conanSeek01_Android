 ...
 * </pre>
 */
public abstract class GencyTextHttpResponseHandler extends GencyAsyncHttpResponseHandler {
    private static final String LOG_TAG = "TextHttpResponseHandler";

    /**
     * Creates new instance with default UTF-8 encoding
     */
    public GencyTextHttpResponseHandler() {
     ...
     */
    public GencyTextHttpResponseHandler(String encoding) {
        super();
        setCharset(encoding);
    }
