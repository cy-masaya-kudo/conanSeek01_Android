...
public abstract class GencyFileAsyncHttpResponseHandler extends GencyAsyncHttpResponseHandler {
     ...
     */
    public GencyFileAsyncHttpResponseHandler(File file) {
        super();
        assert (file != null);
        this.mFile = file;
    }
     ...
     */
    public GencyFileAsyncHttpResponseHandler(Context context) {
        super();
