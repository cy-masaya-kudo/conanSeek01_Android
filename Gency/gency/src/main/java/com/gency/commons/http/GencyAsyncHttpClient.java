 ...
 * GencyRequestParams} instance, and responses can be handled by passing an anonymously overridden {@link
 * GencyResponseHandlerInterface} instance. <p>&nbsp;</p> For example: <p>&nbsp;</p>
 * <pre>
 ...
 * </pre>
 */
public class GencyAsyncHttpClient {
    ...
    private final Map<Context, List<GencyRequestHandle>> requestMap;
     ...
     */
    public GencyAsyncHttpClient(int httpPort) {
     ...
     */
    public GencyAsyncHttpClient(int httpPort, int httpsPort) {
     ...
     */
    public GencyAsyncHttpClient(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
    ...
    private static SchemeRegistry getDefaultSchemeRegistry(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
        ...
        if (fixNoHttpResponseException)
            sslSocketFactory = GencyMySSLSocketFactory.getFixedSocketFactory();
        else
     ...
     */
    public GencyAsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        requestMap = new WeakHashMap<Context, List<GencyRequestHandle>>();
        ...
        httpClient.setHttpRequestRetryHandler(new GencyRetryHandler(DEFAULT_MAX_RETRIES, DEFAULT_RETRY_SLEEP_TIME_MILLIS));
    }

    public static void allowRetryExceptionClass(Class<?> cls) {
        if (cls != null) {
            GencyRetryHandler.addClassToWhitelist(cls);
        }
    }

    public static void blockRetryExceptionClass(Class<?> cls) {
        if (cls != null) {
            GencyRetryHandler.addClassToBlacklist(cls);
        }
    }
    ...
    public void setMaxRetriesAndTimeout(int retries, int timeout) {
        this.httpClient.setHttpRequestRetryHandler(new GencyRetryHandler(retries, timeout));
    }
    ...
    public void cancelRequests(Context context, boolean mayInterruptIfRunning) {
        List<GencyRequestHandle> requestList = requestMap.get(context);
        if (requestList != null) {
            for (GencyRequestHandle requestHandle : requestList) {
     ...
     */
    public GencyRequestHandle head(String url, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle head(String url, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle head(Context context, String url, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle head(Context context, String url, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle head(Context context, String url, Header[] headers, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle get(String url, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle get(String url, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle get(Context context, String url, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle get(Context context, String url, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle get(Context context, String url, Header[] headers, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle post(String url, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle post(String url, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle post(Context context, String url, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle post(Context context, String url, HttpEntity entity, String contentType, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle post(Context context, String url, Header[] headers, GencyRequestParams params, String contentType,
                              GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle post(Context context, String url, Header[] headers, HttpEntity entity, String contentType,
                              GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle put(String url, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle put(String url, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle put(Context context, String url, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle put(Context context, String url, HttpEntity entity, String contentType, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle put(Context context, String url, Header[] headers, HttpEntity entity, String contentType, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle delete(String url, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle delete(Context context, String url, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle delete(Context context, String url, Header[] headers, GencyResponseHandlerInterface responseHandler) {
        final HttpDelete delete = new HttpDelete(url);
     ...
     * @return RequestHandle of future request process
     */
    public GencyRequestHandle delete(Context context, String url, Header[] headers, GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    protected GencyRequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, GencyResponseHandlerInterface responseHandler, Context context) {
        if (contentType != null) {
        ...
        GencyAsyncHttpRequest request = new GencyAsyncHttpRequest(client, httpContext, uriRequest, responseHandler);
        threadPool.submit(request);
        GencyRequestHandle requestHandle = new GencyRequestHandle(request);

        if (context != null) {
            // Add request to request map
            List<GencyRequestHandle> requestList = requestMap.get(context);
            if (requestList == null) {
                requestList = new LinkedList<GencyRequestHandle>();
                requestMap.put(context, requestList);
            }

            requestList.add(requestHandle);

            Iterator<GencyRequestHandle> iterator = requestList.iterator();
     ...
     */
    public static String getUrlWithQueryString(boolean shouldEncodeUrl, String url, GencyRequestParams params) {
        if (shouldEncodeUrl)
            url = url.replace(" ", "%20");
     ...
     */
    private HttpEntity paramsToEntity(GencyRequestParams params, GencyResponseHandlerInterface responseHandler) {
