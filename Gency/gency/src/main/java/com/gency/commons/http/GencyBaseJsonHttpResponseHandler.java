 ...
 */
public abstract class GencyBaseJsonHttpResponseHandler<JSON_TYPE> extends GencyTextHttpResponseHandler {
    private static final String LOG_TAG = "BaseJsonHttpResponseHandler";

    /**
     * Creates a new JsonHttpResponseHandler with default charset "UTF-8"
     */
    public GencyBaseJsonHttpResponseHandler() {
     ...
     */
    public GencyBaseJsonHttpResponseHandler(String encoding) {
        super(encoding);
    }
