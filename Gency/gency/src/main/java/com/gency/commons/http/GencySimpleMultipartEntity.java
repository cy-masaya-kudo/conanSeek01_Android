 ...
 */
class GencySimpleMultipartEntity implements HttpEntity {
    ...
    private GencyResponseHandlerInterface progressHandler;

    private int bytesWritten;

    private int totalSize;

    public GencySimpleMultipartEntity(GencyResponseHandlerInterface progressHandler) {
