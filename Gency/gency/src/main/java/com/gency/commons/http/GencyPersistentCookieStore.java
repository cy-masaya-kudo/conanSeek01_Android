 ...
 */
public class GencyPersistentCookieStore implements CookieStore {
     ...
     */
    public GencyPersistentCookieStore(Context context) {
    ...
    public void addCookie(Cookie cookie) {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + name, encodeCookie(new GencySerializableCookie(cookie)));
        prefsWriter.commit();
    }
     ...
     */
    protected String encodeCookie(GencySerializableCookie cookie) {
        if (cookie == null)
            return null;
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            cookie = ((GencySerializableCookie) objectInputStream.readObject()).getCookie();
